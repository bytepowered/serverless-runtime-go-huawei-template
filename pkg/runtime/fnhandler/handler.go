...
import (
	"fmt"
	runtime2 "huaweicloud.com/runtime/pkg"
	"net/http"
	"os"
	"reflect"
	"runtime"
...
type HandlerFunc func([]byte, runtime2.RuntimeContext) (interface{}, error)

type IRequestHandler interface {
	Handle(payload []byte, ctx runtime2.RuntimeContext) (interface{}, error)
}
...
func (handler *RequestHandler) Handle(payload []byte, ctx runtime2.RuntimeContext) (interface{}, error) {
...
func NewHandler(handlerFunc interface{}) IRequestHandler {
	...
	return &RequestHandler{handlerFunc: HandlerFunc(func(payload []byte, ctx runtime2.RuntimeContext) (interface{}, error) {
...
func (handler *FaultRequestHandler) Handle(payload []byte, ctx runtime2.RuntimeContext) (interface{}, error) {
